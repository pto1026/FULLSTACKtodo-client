  ...
  return (
    <div className="page-container">
      ...
      <div className="header-container">
        ...
        <p className='description'>Deserunt pariatur aute nulla nostrud sint qui. Magna ut fugiat irure id magna. Nostrud enim irure veniam cupidatat aute officia cillum sint id Lorem.</p>
        </div>
        <svg
        ...
        >
          ...
          <path
            ...
            fill="#fff"
          />
          <circle cx="260.50305" cy="297" r="39" fill="#1c7ed6" />
          <path
          ...
          <path
            ...
            fill="#2f2e41"
          />
          <circle cx="591.50305" cy="192" r="13" fill="#1c7ed6" />
          <path
            ...
            fill="#fff"
          />
          <circle cx="591.50305" cy="230" r="13" fill="#1c7ed6" />
          <path
            ...
            fill="#fff"
          />
          <circle cx="598.50305" cy="274" r="13" fill="#1c7ed6" />
          <path
